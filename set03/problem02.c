...
|| version will return true if at least one pair of values has a difference less than p.
&& version will return true only if all pairs of values have differences less than p.*/
